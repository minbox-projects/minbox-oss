 ...
 * @author 恒宇少年
 */
public class AliyunProgressListener implements ProgressListener {
    /**
     * already write bytes
     */
    ...
    public AliyunProgressListener(String objectName, ObjectStorageProgress objectStorageProgress) {
